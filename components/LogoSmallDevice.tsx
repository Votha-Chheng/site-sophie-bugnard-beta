...
const LogoSmallDevice = () => {
  ...
  return (
    <section className="small:min-w-fit min-w-full mx-0 small:mx-auto hd:mx-0 hd:hidden flex justify-between items-center pt-1">
      <Link href={`/versionalt`} className={`flex items-center justify-center small:gap-x-2 gap-x-1`} onClick={onClickLogo}>
        ...
        <div className="w-full translate-y-1">
          ...
          <h2 className={`font-ysabeau text-brown-logo font-bold tracking-tight phone:text-base text-xs leading-3.5 phone:leading-5 mb-2`}>Experte en nutrition, santé féminine & ménopause</h2>
