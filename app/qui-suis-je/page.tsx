...
const QuiSuisJePage = () => {
  ...
  return (
    <BodyLayout className="pb-300">
      ...
      <div className="absolute -translate-x-1/2 left-1/2 top-68">
        <section className="flex mt-16 mb-38 justify-between">
          ...
          <div className="flex w-200 gap-x-1.5 -translate-x-16 h-auto">
            <div className="min-w-70 h-auto border-2 border-white">
              Image illustration cabinet
            </div>
            <ul className="min-w-135 h-auto border-2 border-[#419D78] rounded-2xl bg-white font-ysabeau text-xl text-justify px-5 py-3">
        ...
        <section>
          <div className="relative w-360 h-10">
            <div
              className={` ${hoveredExp ? "opacity-100" : "opacity-0"} absolute cursor-pointer hover:scale-110 transition-transform duration-200 z-20 left-103 -top-5 h-10 w-10 rounded-full bg-main-theme mt-2.5 translate-x-1/2`}
            >
            ...
            <p className={`${hoveredExp3 ? "opacity-100" : "opacity-0"} tracking-wider transition-opacity italic duration-300 absolute bg-[#3ba99c] text-white px-5 py-2 rounded-md top-5 -right-0.5 w-71 text-center font-lato font-semibold`}>
          ...
          <article className="flex w-full mt-12 mb-10 px-7.5 gap-x-16 items-center">
            ...
            <div className="flex gap-x-1.5 min-w-100">
              ...
              <p className="bg-white px-7.5 font-ysabeau text-xl text-justify outline-2 outline-mauve-shadow indent-5 tracking-wider rounded-xl pt-7.5">
